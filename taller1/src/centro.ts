...
class Nivel1{
    ...
    //! añado un nuevo camper al conjusnto de Camper
    agregarCamperTerminado(camper: Camper5){
...
class Camper5{
    ...
    constructor(name: string, nivelInicial: Nivel1){
        this.name = name;
...
enum Contrato {
    SinContrato1 = "No contratado",
    Remoto1 = "Contrato remoto",
